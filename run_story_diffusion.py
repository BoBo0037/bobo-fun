...
#local_dir = "data/"
local_dir = os.path.expanduser("~/.cache/huggingface/hub/models--photomaker-v1/")
...
if single_files:
    pipe = StableDiffusionXLPipeline.from_single_file(
        sd_model_path, torch_dtype=torch.bfloat16
    )
else:
    pipe = StableDiffusionXLPipeline.from_pretrained(
        sd_model_path, torch_dtype=torch.bfloat16, use_safetensors=False
    )
pipe = pipe.to(device)
