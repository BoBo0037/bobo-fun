...
def main():
    ...
    parser.add_argument('--variant', type=str, default='large_44k_v2', help='small_16k, small_44k, medium_44k, large_44k, large_44k_v2')
    ...
    parser.add_argument('--output', type=Path, help='Output directory', default='./output_mmaudio')
