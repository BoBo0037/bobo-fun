...
from src.ltx_video.models.transformers.attention import BasicTransformerBlock
from src.ltx_video.models.transformers.embeddings import get_3d_sincos_pos_embed
from src.ltx_video.utils.skip_layer_strategy import SkipLayerStrategy

from src.ltx_video.utils.diffusers_config_mapping import (
...
class Transformer3DModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        timestep, embedded_timestep = self.adaln_single(
            timestep.flatten().to("mps"), # change to mps
