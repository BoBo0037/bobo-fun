...
from src.genmo.lib.attn_imports import flash_varlen_attn, sage_attn, sdpa_attn_ctx
...
from src.genmo.mochi_preview.dit.joint_model.lora import LoraLinear
...
class AsymmetricAttention(nn.Module):
    ...
    def prepare_qkv(
        ...
        *,
        ...
        assert qkv_x.dtype == torch.float32
